...
$.fn.validateOnBlur=function(language,settings){
    this.find("input[data-validation],textarea[data-validation]").bind("blur.validation",function(){
...
$.fn.validateInputOnBlur=function(language,conf,attachKeyupEvent,eventContext){
    ...
    var $elem=this,$form=$elem.closest("form"),validationRule=$elem.attr(conf.validationRuleAttribute),validation=$.formUtils.validateInput($elem,language,$.extend({},conf,{
...
LANG:{
    ...
    lengthBadStart:"Arasında bir cevap vermelisin",
    lengthBadEnd:" karakterler",
    lengthTooLongStart:"Şu süreden daha uzun bir cevap verdiniz:0 ",
    lengthTooShortStart:"Şundan daha kısa bir cevap verdiniz: ",
    notConfirmed:"Değerler doğrulanamadı",
    badDomain:"Yanlış alan değeri",
    badUrl:"Verdiğiniz cevap doğru bir URL değildi",
    badCustomVal:"Yanlış cevap verdin",
    badInt:"Koltuk Sayısı 40 Yada 49 Olmalıdır",
    badSecurityNumber:"Güvenlik numaranız yanlış",
    badUKVatAnswer:"Hatalı KDV Numarası",
    badStrength:"Şifre yeterince güçlü değil",
    badNumberOfSelectedOptionsStart:"En azından seçmelisin",
    badNumberOfSelectedOptionsEnd:" Yanıtlar",
    badAlphaNumeric:"Verdiğiniz cevap yalnızca alfasayısal karakterler içermelidir",
    badAlphaNumericExtra:" ve ",
    wrongFileSize:"Yüklemeye çalıştığınız dosya çok büyük",
    wrongFileType:"Yüklemeye çalıştığınız dosya yanlış türde",
    groupCheckedRangeStart:"Lütfen aşağıdakiler arasından seçim yapın ",
    groupCheckedTooFewStart:"Lütfen en azından seçin ",
    groupCheckedTooManyStart:"Lütfen en fazla ",
    groupCheckedEnd:" Maddeler"
}
};
