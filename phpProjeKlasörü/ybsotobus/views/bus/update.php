...
<div class="main-form">
    <h1>Otobüs Güncelle</h1>
    <?php
    $url = explode('/', $_GET['url']);
    if (isset($url[2])) {
        if ($url[2] == 'Success')
            echo '<P class="magOk"> Güncelleme Başarılı .... ! </p>';
        if ($url[2] == 'Fail')
            echo '<P class="magNo"> Güncelleme Başarısız ... !</p>';
    }
    ?>
    ...
    ?>" id="uBus_busNo" type="text"  data-validation="required" ><br />			
        ...
        <label ></label>
        <input type="submit" name="updateNewBus" id="updateNewBus" value="Kaydet">
