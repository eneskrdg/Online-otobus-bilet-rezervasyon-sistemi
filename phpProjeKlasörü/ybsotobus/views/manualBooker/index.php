<title>OTOBÜS BİLET REZERVASYON SİSTEMİ</title>
...
<div id="main_about">
    <script>
        $(document).ready(function() {
            ...
            $("#Submit").click(function()
            {
                ...
                if(busSeatEmty==""){
                    $("#divErrorMsg").removeClass().addClass('messageboxerror').text('Seçilen Koltuk Boş!').show();
                    return false;
                }
    ...
    <div id="about_panel">
        <h3>Otobüs Koltuğu Rezervasyonu</h3>
        <div id="busViews">

            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="274" height="40" align="left" valign="middle"><span class="tx3">Servis sağlayıcı : </span>&nbsp;Gezi</td>
                    <td colspan="2" align="left" valign="middle"><span class="tx3">Seyahat  :</span> &nbsp;İSTANBUL&nbsp;&nbsp;<span class="tx3">NEREYE  :</span>&nbsp;&nbsp;GÜRCİSTAN</td>
                </tr>
                <tr>
                    <td height="40" align="left" valign="middle"><span class="tx3">Seyahat Tarihi :</span>
                        2020-03-04</td>
                    <td width="177" align="left" valign="middle"><span class="tx3">Otobüs ücreti : </span>&nbsp;
                        1350 TL</td>
                    <td width="149" align="left" valign="middle"><span class="tx3">Otobüs Tipi : </span>&nbsp;MERCEDES</td>
                </tr>
                ...
                <tr>
                    <td width="500" height="40" align="left" valign="middle">   <script type="text/javascript">
                        $(function () {
                            ...
                            $('.' + settings.seatCss).click(function () {
                                ...
                                if ($(this).hasClass(settings.selectingSeatCssby)){
                                    ...
                                    $.post("common/ajexdtf.php?removeSeat",{ 
                                        ...
                                        $("#seatInfoPot").html('Lütfen Bekleyin...').addClass('messageboxerror').show().fadeOut(10000);
                                    ...
                                    selectSeat();
                                    $("#seatInfoPot").html('Bu Koltuk Bekleme Durumunda').addClass('messageboxerror').show().fadeOut(10000);
                                }else if ($(this).hasClass(settings.selectedSeatCss)){
                                    selectSeat();
                                    $("#seatInfoPot").html('Bu Koltuk Zaten Ayrılmış').addClass('messageboxerror').show().fadeOut(10000);
                            ...
                            function selectSeat(){
                                var slctSeat = [3],realSeat=[1], busfair='1350 TL', totSeat=0;;
    ...
    <div id="rt_side">
        <h3>Koltuk Seç </h3>
        <h2>Bizimle çalışmaktan çekinmeyin</h2>
        <div id="seatForm">
            ...
            <div>
                ...
                <p>
                    <label>Fiyat: </label>
                    <input name="selectValue" type="text" class="form" id="selectValue" style="width:80px;" value="1,350 TL" >
                </p>
                <p>
                    <script> function onButtonClick(){
              document.location = "busdatesearch.php?busfrom=1&busto=55&busdate=2020-03-04";
          } </script>

                    <input name="busdate" type="hidden" id="busdate" value="2020-03-04">
                ...
                <input name="Submit" id="Submit" type="image" src="images/battons/continue.jpg" style="border:0; height:23px; width:80px;" class="button" value="Devam Et" />
